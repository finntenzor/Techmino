...
--------------------------<Generator>--------------------------
function player.loadGameEnv(P)--load gameEnv
...
function player.applyGameEnv(P)--finish gameEnv processing
	local ENV=P.gameEnv
...
function player.prepareSequence(P)--call freshPrepare and set newNext
	local ENV=P.gameEnv
